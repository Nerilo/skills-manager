...
fn build_tray_menu<R: tauri::Runtime>(
    ...
    if scenarios.is_empty() {
        let empty_item =
            MenuItem::with_id(app, "tray-no-presets", "No presets", false, None::<&str>)?;
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::settings::list_wsl_runtime_environments,
            commands::settings::add_wsl_runtime_environment,
            commands::settings::remove_wsl_runtime_environment,
